...
--10.Flag Readmissions Based on Length of Stay
/*Question:
...
--11.Rank hospitals by their total billing amount using window functions.
select Hospital, 
...
--12.Which patients had a greater than 50% increase in average length of stay year-over-year?
with yearly_stay as (
    select name,
...
--13.Identify patients who were readmitted within 30 days of their previous discharge.
